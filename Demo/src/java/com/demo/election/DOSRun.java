...
import static com.demo.election.DOSRun.DOS;
 ...
 *
 * @author BLAZE
 * @since Feb 25, 2023 2:37:31 PM
 */
@Entity
@Table(name = DOS)
public class DOSRun implements Serializable
{
    @Id
    private String id;
    ...
    public static final String DOS = "dirofsocials";
