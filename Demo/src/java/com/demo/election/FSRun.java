...
import static com.demo.election.FSRun.FS;
 ...
 *
 * @author BLAZE
 * @since Feb 25, 2023 2:37:01 PM
 */
@Entity
@Table(name = FS)
public class FSRun implements Serializable
{
    ...
    public static final String FS = "finanalsecretary";
