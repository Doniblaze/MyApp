...
import static com.demo.election.PresidentRun.PRESIDENCY;
 ...
 *
 * @author BLAZE
 * @since Feb 25, 2023 2:36:28 PM
 */
@Entity
@Table(name = PRESIDENCY)
public class PresidentRun implements Serializable
{
    ...
    public static final String PRESIDENCY = "presidency";
