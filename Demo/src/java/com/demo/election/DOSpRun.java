...
import static com.demo.election.DOSpRun.DOSP;
 ...
 *
 * @author BLAZE
 * @since Feb 25, 2023 2:38:16 PM
 */
@Entity
@Table(name = DOSP)
public class DOSpRun implements Serializable
{
    ...
    public static final String DOSP = "dirofsport";
